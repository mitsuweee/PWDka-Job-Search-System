        ...
        try{
            ...
            try{
                ...
                if (userIdRows.length === 0){
                    ...
                    const jobListingIdRows = await connection.query(selectJobListingIdQuery, [joblisting_id])
                    ...
                    `
                        const existingApplicationRows = await connection.query(selectExistingApplicationQuery, [user_id, joblisting_id])
                        ...
                        if (existingApplicationRows.length > 0) {
                            ...
                            const values = jobApplicationModel(user_id, joblisting_id, resume)
                            const jobApplicationObj = [values.user_id, values.joblisting_id, values.resume]
