    ...
    <form className="mt-8 grid grid-cols-12 gap-6" onSubmit={handleSubmit}>
      ...
      <div className="col-span-12 flex justify-between">
        <button
          type="button"
          onClick={handleReset}
          className="px-6 py-2 text-lg shadow-xl font-medium text-white bg-gray-600 rounded-md shadow-sm hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500"
        >
          Reset
        </button>
        <button
          type="submit"
          className="px-6 py-2 text-lg  shadow-xl font-medium text-white bg-blue-600 rounded-md shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
        >
          Sign Up
        </button>
      </div>
...
//       formData.append('first_name', userFormValues.firstName);
//       formData.append('middle_initial', userFormValues.middleInitial);
//       formData.append('last_name', userFormValues.lastName);
//       formData.append('gender', userFormValues.gender);
//       formData.append('address', userFormValues.address);
//       formData.append('city', userFormValues.city);
//       formData.append('birth_date', userFormValues.birthdate);
//       formData.append('contact_number', userFormValues.contactNumber);
//       formData.append('email', userFormValues.email);
//       formData.append('disability_id', userFormValues.disability); 
//       formData.append('password', userFormValues.password);
//       formData.append('confirm_password', userFormValues.reEnterPassword);
//       formData.append('formal_picture', userFormValues.profilePicture);
//       formData.append('picture_with_id', userFormValues.selfieWithID);
//       formData.append('picture_of_pwd_id', userFormValues.idPicture);
...
//       // Handle company form submission logic if needed
//     }
//   };
