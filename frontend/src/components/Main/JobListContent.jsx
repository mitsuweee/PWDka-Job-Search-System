              ...
              {currentJobs.length > 0 ? (
                ...
                <div className="flex justify-center items-center h-64">
                  <p className="text-gray-600">
                    ...
                    assured, we are actively working to provide new
                    opportunities tailored to your unique skills and abilities.
                    Stay positive—your next opportunity is just around the
                    corner!
                  </p>
                </div>
              )}
            ...
            <div className="bg-white p-6 rounded-lg shadow-xl max-w-lg w-full">
              ...
              <div className="mb-6">
                <p className="text-lg text-gray-600">
                  Are you sure you want to logout? You will need to log back in
