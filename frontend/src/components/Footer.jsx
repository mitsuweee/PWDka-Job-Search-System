      ...
      <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            <div className="flex justify-center text-custom-blue sm:justify-start">
              <img
                src="/imgs/LOGO PWDKA.png" // Replace with the actual path to your logo image
                alt="Company Logo"
                className="h-12" // Adjust height or other styling as needed
              />
            </div>

            <p className="mt-6 max-w-md text-center leading-relaxed text-gray-500 sm:max-w-xs sm:text-left">
              We are driven by a vision of a world where every individual,
            ...
            <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
              ...
              <li>
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className="text-custom-blue transition hover:text-blue-400"
                >
        ...
        <div className="mt-12 border-t border-gray-100 pt-6">
          <div className="text-center sm:flex sm:justify-between sm:text-left">
            ...
            <p className="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">
              &copy; 2024 PWDKa Development Team
            </p>
          </div>
        </div>
      </div>
