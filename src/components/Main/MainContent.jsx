    ...
    <div style={{ padding: '20px' }}>
      ...
      <div>
        <div style={{ marginBottom: '20px' }}>
          <button style={filterButtonStyle} onClick={() => handleFilterChange('latest-past')}>Latest - Past</button>
          <button style={filterButtonStyle} onClick={() => handleFilterChange('salary')}>Salary</button>
          <button style={filterButtonStyle} onClick={() => handleFilterChange('city')}>City</button>
        </div>
